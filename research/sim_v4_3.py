...
def run_v4_3_simulation():
    print("🧪 SIMULATION: Hybrid v4.3 (Strict Squeeze + Breathing Room)...")
    ...
    for date_str in days:
        ...
        for sym in symbols:
            ...
            for i in today_idxs:
                ...
                # NO TIERING. Just strict silence.
                ...
                print(f"🚀 ENTRY: {sym} @ {entry_price:.2f} ({current_time.strftime('%H:%M')}) | BW: {bw.iloc[i]:.3f} | Spot P&L: -")
